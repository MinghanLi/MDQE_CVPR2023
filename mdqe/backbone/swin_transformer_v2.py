...
__all__ = [
    "build_swinv2_backbone",
    "build_swinv2_fpn_backbone"
]
...
class SwinTransformerV2(Backbone):
    ...
    def __init__(self,
        ...
        for i_layer in range(self.num_layers):
            window_size_ = window_size//2 if (i_layer == self.num_layers-1) else window_size
...
def build_swinv2_backbone(cfg, input_shape):
    """
    Create a Swin instance from config.
    Returns:
...
@BACKBONE_REGISTRY.register()
def build_swinv2_fpn_backbone(cfg, input_shape: ShapeSpec):
    """
    Args:
